...
"[project]/app/api/admin/products/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    try {
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].product.findMany({
            orderBy: {
                createdAt: 'desc'
            }
        });
...
async function POST(req) {
    try {
        ...
        if (session.role === 'admin') {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].pendingUpdate.create({
                data: {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                message: 'Product creation submitted for superadmin approval'
            });
        }
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].product.create({
            data: {
                name,
                description,
                price: parseFloat(price),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__59715e89._.js.map