...
"[project]/app/api/admin/services/route.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    ...
    try {
        const services = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].service.findMany({
            orderBy: {
                createdAt: 'desc'
            }
        });
...
async function POST(req) {
    try {
        ...
        if (session.role === 'admin') {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true,
                message: 'Service creation submitted for superadmin approval'
            });
        }
        const service = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].service.create({
            data: {
                name,
                description,
                image: imagePath
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bbcd355b._.js.map