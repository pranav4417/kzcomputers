...
const EMAIL_USER = process.env.EMAIL_USER || 'sales.kzcomputers@gmail.com';
                ...
                <tr>
                  <td style="font-family:Inter,sans-serif;background:#1A202C;padding:30px 20px;border-radius:16px;">
                    <div style="text-align:center;margin-bottom:30px;">
                      ...
                      <p style="color:#888;font-size:11px;margin:4px 0 0 0;">GSTIN: 29AANCK0673R1ZL | CIN: U62099KA2026PTC224499 | 📞 8971132109 | 📧 sales.kzcomputers@gmail.com</p>
                    </div>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" width="600" style="background:#fff;border-radius:8px;overflow:hidden;">
                ...
                <tr>
                  <td style="background:#333;padding:20px;text-align:center;">
                      <p style="margin:0;color:#888;font-size:12px;">KZ COMPUTERS | NO.483 & 484, Nimishamba, Square Amrutahalli, Amruthahalli, Bangalore, Bangalore North, Karnataka, India, 560092 | GSTIN: 29AANCK0673R1ZL | CIN: U62099KA2026PTC224499 | sales.kzcomputers@gmail.com | 8971132109</p>
                  </td>
                </tr>
              </table>
            </td>
